...
<template>
  <div class="xtx-goods-page" v-if="detail.name">
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/${detail.categories[0].id}` }">{{ detail.categories[0].name }}
          </el-breadcrumb-item>
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <XtxImageView :image-list="detail.mainPictures"></XtxImageView>
              <!-- 统计数量 -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img v-for="img in detail.details.pictures" :src="img" :key="img">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
